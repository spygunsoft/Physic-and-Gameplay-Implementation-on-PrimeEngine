...
#include "Characters/ImrodNPCMovementSM.h"
#include "Characters/ImrodNPCBehaviorSM.h"
	...
	// start root
	{
		...
		// start root.CharacterControl
		{
			...
			// start root.CharacterControl.Components
			{
				...
				ImrodNPC::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
				ImrodNPCMovementSM::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
				ImrodNPCBehaviorSM::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
			...
			// start root.CharacterControl.Events
			{
				...
				Event_CreateImrodNPC::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
				...
				ImrodNPCMovementSM_Event_MOVE_TO::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
				ImrodNPCMovementSM_Event_TARGET_REACHED::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
				ImrodNPCMovementSM_Event_STOP::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
