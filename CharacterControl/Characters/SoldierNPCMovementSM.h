...
struct SoldierNPCMovementSM_Event_STOP : public PE::Events::Event {
	...
	SoldierNPCMovementSM_Event_STOP(Vector3 targetName = Vector3());

	Vector3 m_targetName;
};
...
struct SoldierNPCMovementSM_Event_TARGET_REACHED : public PE::Events::Event {
	...
	SoldierNPCMovementSM_Event_TARGET_REACHED(Vector3 targetName = Vector3());
