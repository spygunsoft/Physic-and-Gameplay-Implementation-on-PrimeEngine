...
struct Event_GATHER_DRAWCALLS : public Event {
	...
	Vector3 m_frontPlaneNormal;
	PrimitiveTypes::Float32 m_frontPlaneOffset;

	Vector3 m_leftPlaneNormal;
	PrimitiveTypes::Float32 m_leftPlaneOffset;

	Vector3 m_bottomPlaneNormal;
	PrimitiveTypes::Float32 m_bottomPlaneOffset;

	Vector3 m_rightPlaneNormal;
	PrimitiveTypes::Float32 m_rightPlaneOffset;

	Vector3 m_topPlaneNormal;
	PrimitiveTypes::Float32 m_topPlaneOffset;

	Vector3 m_backPlaneNormal;
	PrimitiveTypes::Float32 m_backPlaneOffset;
...
struct Event_PHYSICS_COLLISION : public Event {
	PE_DECLARE_CLASS(Event_PHYSICS_COLLISION);

	Event_PHYSICS_COLLISION(){}
	virtual ~Event_PHYSICS_COLLISION(){}

	Components::Physics::CollisionGroup group1;
	Components::Physics::CollisionGroup group2;
	Handle m_node1;
	Handle m_node2;
};
#endif
