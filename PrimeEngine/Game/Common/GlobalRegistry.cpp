...
#include "PrimeEngine/Physic/PhysicsComponent.h"
		...
		// start root.PE
		{
			...
			// start root.PE.Events
			{
				PE::Events::Event::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
					...
					PE::Events::Event_UPDATE_PHYSIC::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
					PE::Events::Event_PRE_PHYSIC::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
					PE::Events::Event_POST_PHYSIC::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
					...
					PE::Events::Event_PHYSICS_COLLISION::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
	#endif
					//PE::Events::Event_CREATE_PHYSIC::InitializeAndRegister(pLuaEnv,pRegistry,setLuaMetaDataOnly);
