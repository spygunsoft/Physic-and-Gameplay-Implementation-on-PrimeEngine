...
struct CameraSceneNode : public SceneNode
{
	...
	Vector3 frontPlaneNormal, leftPlaneNormal, bottomPlaneNormal, rightPlaneNormal, topPlaneNormal, backPlaneNormal;
	PrimitiveTypes::Float32 frontPlaneOffset, leftPlaneOffset, bottomPlaneOffset, rightPlaneOffset, topPlaneOffset, backPlaneOffset;
