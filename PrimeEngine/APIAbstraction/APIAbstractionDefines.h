...
// APIABSTRACTION_D3D9 AND _XBOX - XBOX360
...
#ifndef APIABSTRACTION_X360
#define APIABSTRACTION_X360 0
#endif

#if APIABSTRACTION_D3D9 && !APIABSTRACTION_X360
...
#if (APIABSTRACTION_D3D9 && !defined(_XBOX)) || APIABSTRACTION_D3D11 || APIABSTRACTION_GLPC
...
#define PE_ENABLE_GPU_PROFILING 0 //(!APIABSTRACTION_OGL && !APIABSTRACTION_X360)
...
#ifndef PE_PLAT_IS_XBOX360
#define PE_PLAT_IS_XBOX360 0
#endif
